...
int main(int argc, char* argv[]) {
	...
	StubPath = basePath + "\\lib\\Shellnd.exe";
	...
	if (CopyFile(StubPath, m_SavePath, false))
	{
		...
		if (hRes != NULL)
		{
			...
			ResourceInfo resources[] = {
				...
				{ basePath + _T("\\lib\\MemoryPattern\\Detectdriver.sys"), L"Detectdriver.sys", L"null", 3 },
				{ basePath + _T("\\lib\\Detector\\Collection-x64.dll"), L"Collection-x64.dll", L"null", 4 },
				{ basePath + _T("\\lib\\eDetectorobject\\ClientSearchTools\\EnumProcess.sys"), L"EnumProcess.sys", L"null", 5 },
				{ basePath + _T("\\lib\\eDetectorobject\\WhiteList\\WhiteList-x64.dll"), L"WhiteList-x64.dll", L"null", 6 },
				{ basePath + _T("\\lib\\eDetectorobject\\WhiteList\\WhiteList-x86.dll"), L"WhiteList-x86.dll", L"null", 7 },
				{ basePath + _T("\\lib\\iForensicsService.exe"), L"iForensicsService.exe", m_CommandStr1, 8 },
				{ basePath + _T("\\lib\\Detector\\Collection-x86.dll"), L"Collection-x86.dll", L"null", 9 },

				{ basePath + _T("\\lib\\dll\\x86\\api-ms-win-core-heap-l1-1-0.dll"), L"api-ms-win-core-heap-l1-1-0.dll", L"null", 11 },
				{ basePath + _T("\\lib\\dll\\x86\\api-ms-win-crt-convert-l1-1-0.dll"), L"api-ms-win-crt-convert-l1-1-0.dll", L"null", 12 },
				{ basePath + _T("\\lib\\dll\\x86\\api-ms-win-crt-heap-l1-1-0.dll"), L"api-ms-win-crt-heap-l1-1-0.dll", L"null", 13 },
				{ basePath + _T("\\lib\\dll\\x86\\api-ms-win-crt-locale-l1-1-0.dll"), L"api-ms-win-crt-locale-l1-1-0.dll", L"null", 14 },
				{ basePath + _T("\\lib\\dll\\x86\\api-ms-win-crt-math-l1-1-0.dll"), L"api-ms-win-crt-math-l1-1-0.dll", L"null", 15 },
				{ basePath + _T("\\lib\\dll\\x86\\api-ms-win-crt-private-l1-1-0.dll"), L"api-ms-win-crt-private-l1-1-0.dll", L"null", 16 },
				{ basePath + _T("\\lib\\dll\\x86\\api-ms-win-crt-runtime-l1-1-0.dll"), L"api-ms-win-crt-runtime-l1-1-0.dll", L"null", 17 },
				{ basePath + _T("\\lib\\dll\\x86\\api-ms-win-crt-stdio-l1-1-0.dll"), L"api-ms-win-crt-stdio-l1-1-0.dll", L"null", 18 },
				{ basePath + _T("\\lib\\dll\\x86\\api-ms-win-crt-string-l1-1-0.dll"), L"api-ms-win-crt-string-l1-1-0.dll", L"null", 19 },
				{ basePath + _T("\\lib\\dll\\x86\\concrt140.dll"), L"concrt140.dll", L"null", 20 },
				{ basePath + _T("\\lib\\dll\\x86\\msvcp_win.dll"), L"msvcp_win.dll", L"null", 20 },
				{ basePath + _T("\\lib\\dll\\x86\\msvcp140.dll"), L"msvcp140.dll", L"null", 22 },
				{ basePath + _T("\\lib\\dll\\x86\\msvcp140_1.dll"), L"msvcp140_1.dll", L"null", 23 },
				{ basePath + _T("\\lib\\dll\\x86\\msvcrt.dll"), L"msvcrt.dll", L"null", 24 },
				{ basePath + _T("\\lib\\dll\\x86\\ucrtbase.dll"), L"ucrtbase.dll", L"null", 25 },
				{ basePath + _T("\\lib\\dll\\x86\\vcruntime140.dll"), L"vcruntime140.dll", L"null", 26 },
				{ basePath + _T("\\lib\\dll\\x86\\wlanapi.dll"), L"wlanapi.dll", L"null", 27 },

				{ basePath + _T("\\lib\\dll\\x64\\api-ms-win-core-heap-l1-1-0.dll"), L"api-ms-win-core-heap-l1-1-0.dll", L"null", 28 },
				{ basePath + _T("\\lib\\dll\\x64\\api-ms-win-crt-convert-l1-1-0.dll"), L"api-ms-win-crt-convert-l1-1-0.dll", L"null", 29 },
				{ basePath + _T("\\lib\\dll\\x64\\api-ms-win-crt-heap-l1-1-0.dll"), L"api-ms-win-crt-heap-l1-1-0.dll", L"null", 30 },
				{ basePath + _T("\\lib\\dll\\x64\\api-ms-win-crt-locale-l1-1-0.dll"), L"api-ms-win-crt-locale-l1-1-0.dll", L"null", 31 },
				{ basePath + _T("\\lib\\dll\\x64\\api-ms-win-crt-math-l1-1-0.dll"), L"api-ms-win-crt-math-l1-1-0.dll", L"null", 32 },
				{ basePath + _T("\\lib\\dll\\x64\\api-ms-win-crt-private-l1-1-0.dll"), L"api-ms-win-crt-private-l1-1-0.dll", L"null", 33 },
				{ basePath + _T("\\lib\\dll\\x64\\api-ms-win-crt-runtime-l1-1-0.dll"), L"api-ms-win-crt-runtime-l1-1-0.dll", L"null", 34 },
				{ basePath + _T("\\lib\\dll\\x64\\api-ms-win-crt-stdio-l1-1-0.dll"), L"api-ms-win-crt-stdio-l1-1-0.dll", L"null", 35 },
				{ basePath + _T("\\lib\\dll\\x64\\api-ms-win-crt-string-l1-1-0.dll"), L"api-ms-win-crt-string-l1-1-0.dll", L"null", 36 },
				{ basePath + _T("\\lib\\dll\\x64\\concrt140.dll"), L"concrt140.dll", L"null", 37 },
				{ basePath + _T("\\lib\\dll\\x64\\msvcp_win.dll"), L"msvcp_win.dll", L"null", 38 },
				{ basePath + _T("\\lib\\dll\\x64\\msvcp140.dll"), L"msvcp140.dll", L"null", 39 },
				{ basePath + _T("\\lib\\dll\\x64\\msvcp140_1.dll"), L"msvcp140_1.dll", L"null", 40 },
				{ basePath + _T("\\lib\\dll\\x64\\msvcrt.dll"), L"msvcrt.dll", L"null", 41 },
				{ basePath + _T("\\lib\\dll\\x64\\ucrtbase.dll"), L"ucrtbase.dll", L"null", 42 },
				{ basePath + _T("\\lib\\dll\\x64\\vcruntime140.dll"), L"vcruntime140.dll", L"null", 43 },
				{ basePath + _T("\\lib\\dll\\x64\\wlanapi.dll"), L"wlanapi.dll", L"null", 44 },
				{ basePath + _T("\\lib\\dll\\x64\\api-ms-win-core-heap-l2-1-0.dll"), L"api-ms-win-core-heap-l2-1-0.dll", L"null", 45 }
