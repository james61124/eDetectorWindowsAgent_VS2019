...
public:
	...
	__inline const CAttrBase* FindRecoveryFirstAttr(DWORD attrType) const; // 11202012 debug add
...
// 11202012 Debug add ->
__inline const CAttrBase* CFileRecord::FindRecoveryFirstAttr(DWORD attrType) const
{
...
//Get Parent Ref
__inline ULONGLONG CFileRecord::GetParentRef() const
{
	CAttr_FileName* fn = (CAttr_FileName*)AttrList[ATTR_INDEX(ATTR_TYPE_FILE_NAME)].FindFirstEntry();
...
__inline void CFileRecord::GetFileCreateTime(FILETIME* createTm) const
{
	// Standard Information attribute hold the most updated file time
	CAttr_StdInfo* si = (CAttr_StdInfo*)AttrList[ATTR_INDEX(ATTR_TYPE_STANDARD_INFORMATION)].FindFirstEntry();
	if (si)
...
__inline void CFileRecord::GetFileWriteTime(FILETIME* writeTm) const
{
	// Standard Information attribute hold the most updated file time
	CAttr_StdInfo* si = (CAttr_StdInfo*)AttrList[ATTR_INDEX(ATTR_TYPE_STANDARD_INFORMATION)].FindFirstEntry();
	if (si)
...
__inline void CFileRecord::GetFileAccessTime(FILETIME* accessTm) const
{
	// Standard Information attribute hold the most updated file time
	CAttr_StdInfo* si = (CAttr_StdInfo*)AttrList[ATTR_INDEX(ATTR_TYPE_STANDARD_INFORMATION)].FindFirstEntry();
	if (si)
...
__inline void CFileRecord::GetEntryModifiedTime(FILETIME* entrymodTm) const
{
	// Standard Information attribute hold the most updated file time
	CAttr_StdInfo* si = (CAttr_StdInfo*)AttrList[ATTR_INDEX(ATTR_TYPE_STANDARD_INFORMATION)].FindFirstEntry();
	if (si)
