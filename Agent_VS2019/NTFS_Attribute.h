...
public:
	...
	virtual __inline ULONGLONG GetAllocSize(ULONGLONG* allocSize = NULL) const = 0; //0709-2013
	virtual __inline ULONGLONG GetComSize(ULONGLONG* allocSize = NULL) const = 0;//0715-2013
	virtual __inline DWORD GetClusterSize() const = 0;
...
public:
	...
	virtual __inline ULONGLONG GetAllocSize(ULONGLONG* allocSize = NULL) const; //0709-2013
	virtual __inline ULONGLONG GetComSize(ULONGLONG* allocSize = NULL) const;
	virtual __inline DWORD GetClusterSize() const;
...
//0709-2013 ->
__inline ULONGLONG CAttrResident::GetAllocSize(ULONGLONG* allocSize) const
{
	if (allocSize)
		*allocSize = AttrBodySize;
...
//0709-2013<-
__inline ULONGLONG CAttrResident::GetComSize(ULONGLONG* allocSize) const
{
	if (allocSize)
		*allocSize = AttrBodySize;
...
__inline DWORD CAttrResident::GetClusterSize() const
{
	return _ClusterSize;
}
//0715-2013
...
public:
	virtual __inline ULONGLONG GetDataSize(ULONGLONG* allocSize = NULL) const;
	virtual __inline ULONGLONG GetAllocSize(ULONGLONG* allocSize = NULL) const; //0709-2013
	virtual __inline ULONGLONG GetComSize(ULONGLONG* allocSize = NULL) const; //0715-2013
	virtual __inline DWORD GetClusterSize() const;
	virtual BOOL ReadData(const ULONGLONG& offset, void* bufv, DWORD bufLen, DWORD* actural) const;
	virtual BOOL ReadCompressedData(const ULONGLONG& offset, void* bufv, DWORD bufLen, DWORD* actural) const; //0709-2013
	virtual BOOL ReadIniSizeData(const ULONGLONG& offset, void* bufv, DWORD bufLen, DWORD* actural) const; //0715-2013
...
//0709-2013 ->
__inline ULONGLONG CAttrNonResident::GetAllocSize(ULONGLONG* allocSize) const
{
	if (allocSize)
		*allocSize = AttrHeaderNR->AllocSize;
...
//0709-2013 <-
__inline ULONGLONG CAttrNonResident::GetComSize(ULONGLONG* allocSize) const
{
	if (allocSize)
		*allocSize = AttrHeaderNR->AllocSize;
...
__inline DWORD CAttrNonResident::GetClusterSize() const
{
	return _ClusterSize;
}
//0715-2013
...
public:
	...
	__inline void GetFileCreateTime(FILETIME* createTm) const;
	__inline void GetFileFileCreateTime(FILETIME* createTm) const;
	__inline void GetFileWriteTime(FILETIME* writeTm) const;
	__inline void GetFileFileWriteTime(FILETIME* writeTm) const;
	__inline void GetFileAccessTime(FILETIME* accessTm) const;
	__inline void GetFileFileAccessTime(FILETIME* accessTm) const;
	//__inline void GetEntryModifiedTime(FILETIME *accessTm ) const;
	__inline void GetEntryModifiedTime(FILETIME* entrymodTm) const;
	__inline void GetFileEntryModifiedTime(FILETIME* entrymodTm) const;
...
__inline void CAttr_StdInfo::GetFileCreateTime(FILETIME* createTm) const
{
	UTC2Local(StdInfo->CreateTime, createTm);
}
__inline void CAttr_StdInfo::GetFileFileCreateTime(FILETIME* createTm) const
{
	UTC2Local(StdFile->CreateTime, createTm);
}

__inline void CAttr_StdInfo::GetFileWriteTime(FILETIME* writeTm) const
{
	UTC2Local(StdInfo->AlterTime, writeTm);
}
__inline void CAttr_StdInfo::GetFileFileWriteTime(FILETIME* writeTm) const
{
	UTC2Local(StdFile->AlterTime, writeTm);
}
__inline void CAttr_StdInfo::GetFileAccessTime(FILETIME* accessTm) const
{
	UTC2Local(StdInfo->ReadTime, accessTm);
}
__inline void CAttr_StdInfo::GetFileFileAccessTime(FILETIME* accessTm) const
{
	UTC2Local(StdFile->ReadTime, accessTm);
}
__inline void CAttr_StdInfo::GetEntryModifiedTime(FILETIME* entrymodTm) const
{
	//UTC2Local(StdFile->MFTTime, entrymodTm);	
	UTC2Local(StdInfo->MFTTime, entrymodTm);
}
__inline void CAttr_StdInfo::GetFileEntryModifiedTime(FILETIME* entrymodTm) const
{
	UTC2Local(StdFile->MFTTime, entrymodTm);
}
...
public:
	...
	__inline ULONGLONG GetFileAllocSize() const;
	__inline DWORD GetFilePermission() const;
	__inline BOOL IsReadOnly() const;
	__inline BOOL IsHidden() const;
	__inline BOOL IsSystem() const;
	...
	__inline void GetFileWriteTime(FILETIME* writeTm) const;
	__inline void GetFileAccessTime(FILETIME* accessTm) const;
	__inline ULONGLONG GetParentRef() const;
};	// CFileName
...
__inline ULONGLONG CFileName::GetFileAllocSize() const
{
...
__inline void CFileName::GetFileCreateTime(FILETIME* createTm) const
{
	CAttr_StdInfo::UTC2Local(FileName ? FileName->CreateTime : 0, createTm);
}
__inline void CFileName::GetFileWriteTime(FILETIME* writeTm) const
{
	CAttr_StdInfo::UTC2Local(FileName ? FileName->AlterTime : 0, writeTm);
}
__inline void CFileName::GetFileAccessTime(FILETIME* accessTm) const
{
	CAttr_StdInfo::UTC2Local(FileName ? FileName->ReadTime : 0, accessTm);
}

__inline ULONGLONG CFileName::GetParentRef() const
{
