...
public:
	...
	virtual bool load(void *argv,char* pMAC,char* pIP,DWORD FatherID,char * SendStr,unsigned int & pProgressCount,unsigned int & pCount,DWORD & pLastCluster,vector<DeleteFATFileInfo>* pDelInfo,clock_t & pStartTime);
